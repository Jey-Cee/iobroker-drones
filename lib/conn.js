...
let servConn = {
    ...
    _onAuth:          function (objectsRequired, isSecure) {
        ...
        this._socket.emit('subscribe', 'drones.*');
        if (objectsRequired) this._socket.emit('subscribeObjects', 'drones*');
    ...
    getVersion:       function (callback) {
        ...
        this._socket.emit('getVersion', (error, version) => {
    ...
    writeFile64:      function (filename, data, callback) {
        ...
        this._socket.emit('writeFile64', adapter, parts.join('/'), atob(data), {mode: this._defaultMode}, callback);
    },
